...
| Phase 25: Code Restructure        | 📋 Planned   | Split main.rs, hierarchical modules, explicit CPU/GPU    |
...
- [Phase 25: Code Restructure](phase-25-code-restructure.md) 📋 - Split main.rs, hierarchical modules, explicit CPU/GPU paths
